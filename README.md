...
```bash
Unity -batchmode -nographics -projectPath PATH_TO_PROJECT -buildTarget Android -executeMethod AssetBundleBuilder.BuildAssetBundlesFromParams -bundleName mybundle -assetPaths PATH_TO_ASSETS -outputPath "Build/AssetBundles" -quit
```
